...
class ShowBookIncome(QWidget):
    def __init__(self, parent=None):
        super(ShowBookIncome, self).__init__(parent)
        self.path = os.path.join('faces', 'show_book_income.ui')
    ...
    def create_report(self):
        # Я выставил формат вывода "yyyy" через дизайнер.
        # В принципе можно использовать обычный комбобокс, но тогда надо будет в него вставлять год
        d = self.date_start.text()
        print(type(d), d)
